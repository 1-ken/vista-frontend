      ...
      <div className="max-w-5xl w-full bg-white rounded-[3rem] shadow-luxury overflow-hidden flex flex-col md:flex-row border border-slate-100">
        ...
        <div className="md:w-7/12 p-12 md:p-20 bg-white">
          <div className="mb-12">
            ...
            <p className="text-xs text-slate-400 font-medium uppercase tracking-widest">Continue to Dashboard</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-8">
            <div className="space-y-6">
              ...
              <div className="group">
                <label className="text-[10px] uppercase tracking-widest font-black text-slate-400 group-focus-within:text-accent transition-colors mb-3 px-1 block">
                  Security Password
                </label>
                <div className="relative">
